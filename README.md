...
Le framework applique rigoureusement le modèle POM (Page Object Model) couplé à Page Factory afin d'assurer l'indépendance entre la description graphique des pages
et la logique de test.
